...
-- census_data
-- add all the birth records from citizen data to census data
...
-- query to add death event in census data who is not an employee and is born before 1980
INSERT INTO census_data (household_id, citizen_id, event_type, event_date)
...
-- query to add marriage event in census data for all citizens who are born before 2000
INSERT INTO census_data (household_id, citizen_id, event_type, event_date)
...
-- query to add divorce event in census data for all citizens who are born between 1990 and 2000
INSERT INTO census_data (household_id, citizen_id, event_type, event_date)
...
-- queries
-- Show names of all citizens who holds more than 1 acre of land 
SELECT c.name
    FROM citizen c
        JOIN land_record l 
...
-- Show name of all girls who study in school with household income less than 1 Lakh per year 
SELECT c.name
    FROM household h
        JOIN citizen c 
...
-- How many acres of land cultivate rice
